...
urlpatterns = [
    ...
    path('posts/view/foreign-post/create-comment', views.create_foreign_comment, name="create-foreign-comment"),
    path('posts/view/foreign-post/comments', views.view_foreign_comment, name="view-foreign-comment"),
    path('posts/view/foreign-post/share-post', views.share_foreign_post, name="share_foreign_post"),
